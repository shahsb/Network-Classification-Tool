...
def applyPCA(data):
	...
	analyze_k_means(kmeans_2d, name = "Kmeans2d", data = reduced_data, labels = output_labels_2d)
	
	analyze_k_means(kmeans_3d, name = "Kmeans3d", data = reduced_data_3d, labels = output_labels_3d)
